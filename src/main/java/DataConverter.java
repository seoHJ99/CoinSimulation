...
public class DataConverter {
    ...
    int rowSize =0;
    final String FILE_PATH = "C:\\Users\\Hojun\\Desktop\\git\\CoinSimulation\\";

    // Exel 데이터를 필드 candelMap 으로 변환하는 함수.
    public void setExelDataToCandleMap(String fileName) throws IOException {
        ...
        for (int i = 0; i < sheetNum; i++) {
            ...
            Data.exelData.put(sheet.getSheetName(), candleList);
        }
        fis.close();
    }
